...
export const getAssignments = () => {
  setAuth({})
  return getJson(`${config.apiUrl}/assignment/assignments?allRealm=true`)
}

export const getSequences = id =>
  getJson(`${config.apiUrl}/assignment/assignments/${id}/sequences`)

export const getSequenceCards = (id, seqId) =>
  getJson(`${config.apiUrl}/assignment/assignments/${id}/sequences/${seqId}/cards`)
